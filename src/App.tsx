...
const projects: Project[] = [
  {
    title: "BEACON\nCAPITAL PARTNERS",
    subtitle: "Leading brand execution at a real estate firm",
    tag: "GRAPHIC DESIGN",
    bg: "linear-gradient(155deg, #2a4a8c 0%, #1e3a6e 100%)",
    textClass: "text-white",
    to: "/beacon-capital-partners",
  },
  {
    title: "Asian\nStudent Union",
    subtitle: "Driving engagement for NEU's Asian American community",
    tag: "GRAPHIC DESIGN · MOTION DESIGN",
    bg: "linear-gradient(155deg, #d99aa0 0%, #b86d7a 100%)",
    textClass: "text-white",
  },
  {
    title: "CITY of BOSTON",
    subtitle: "Developing a first time home-buying guide for Boston residents",
    tag: "PRODUCT DESIGN",
    bg: "linear-gradient(155deg, #e8826b 0%, #d65a4a 100%)",
    textClass: "text-white",
  },
  {
    title: "SCOOTER'S\nCOFFEE",
    subtitle: "Building a reward checkout flow for USA's fifth largest coffee chain",
    tag: "PRODUCT DESIGN",
    bg: "linear-gradient(155deg, #c43a2d 0%, #9c2a20 100%)",
    textClass: "text-white",
  },
  {
    title: "Gal",
    subtitle: "Crafting a digital experience for first-time female gym-goers",
    tag: "PRODUCT DESIGN",
    bg: "linear-gradient(155deg, #b9a5e8 0%, #9785d6 100%)",
    textClass: "text-foreground",
  },
  {
    title: "Learnt.",
    subtitle: "Making learning fun",
    tag: "PRODUCT DESIGN",
    bg: "linear-gradient(155deg, #f5a8e0 0%, #e87fd0 100%)",
    textClass: "text-foreground",
  },
  {
    title: "inspira\nFINANCIAL",
    subtitle: "Optimizing UI/UX for a wealth management website",
    tag: "GRAPHIC DESIGN",
    bg: "linear-gradient(155deg, #5a72d6 0%, #3f56b8 100%)",
    textClass: "text-white",
  },
  {
    title: "Motion Design",
    ...
    tag: "MOTION DESIGN",
    bg: "linear-gradient(180deg, #6b5b95 0%, #a78bc4 60%, #e8c97a 100%)",
    textClass: "text-white",
  },
];
...
function ProjectCard({ project }: { project: Project }) {
    ...
    >
      <div className="flex h-full flex-col justify-between">
        <div className="flex items-start justify-between gap-3">
          <h3 className="whitespace-pre-line text-xl font-bold leading-tight md:text-2xl">
            {project.title}
          </h3>
  ...
  if (project.to) {
    return <a href={project.to} className="block">{content}</a>;
  }
  return content;
}
      ...
      <main className="mx-auto max-w-6xl px-6">
        <section className="flex flex-col items-center pt-10 pb-14 text-center">
          ...
          <h1 className="text-2xl leading-relaxed md:text-3xl md:leading-relaxed">
            ...
            product, graphic, and motion designer.
          </h1>
        ...
        <section className="grid grid-cols-1 gap-5 pb-10 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <a href="/playground" className="group flex aspect-square flex-col items-center justify-center rounded-md text-center transition-transform hover:-translate-y-1">
        ...
        <section className="py-20 text-center">
          <p className="text-lg md:text-xl">
            Thank you so much for your time —<br />I'd love to connect!
          </p>
